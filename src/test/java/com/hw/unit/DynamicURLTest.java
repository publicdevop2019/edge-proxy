...
public class DynamicURLTest {
    ...
    public void getDynamicUrlParamsNoParams() {
        ...
        securityProfile.setPath("/api/profiles");
        ...
        securityProfile.setUrl("http://localhost:8082/v1/api/profiles");
        String s = dynamicRouteFilter.updateTargetUrl(dynamicUrlParams, securityProfile.getUrl());

        Assert.assertEquals(securityProfile.getUrl(), s);
    }
    ...
    public void getDynamicUrlParamsMiddle() {
        ...
        securityProfile.setUrl("http://localhost:8082/v1/api/profiles/**/addresses");
        String s = dynamicRouteFilter.updateTargetUrl(dynamicUrlParams, securityProfile.getUrl());
    ...
    public void getDynamicUrlParamsMiddleAndEndThenMiddleEnd() {
        DynamicRouteFilter dynamicRouteFilter = new DynamicRouteFilter();
        SecurityProfile securityProfile = new SecurityProfile();
        securityProfile.setPath("/api/profiles/**/addresses/**/city/**");
        ...
        securityProfile.setUrl("http://localhost:8082/v1/api/profiles/**/addresses/**/city/**");
        String s = dynamicRouteFilter.updateTargetUrl(dynamicUrlParams, securityProfile.getUrl());
